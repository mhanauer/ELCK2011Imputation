...
modelAP1Coef = as.data.frame(modelAP1Coef)
...
modelSC2Coef = as.data.frame(modelSC2Coef)
...
modelSI2Coef = as.data.frame(modelSI2Coef)
...
modelSL2Coef = as.data.frame(modelSL2Coef)
...
modelIO2Coef = as.data.frame(modelIO2Coef)
...
modelAP2Coef = as.data.frame(modelAP2Coef)
```
...
modelSC3Coef = as.data.frame(modelSC3Coef)
...
modelSI3Coef = as.data.frame(modelSI3Coef)
...
modelSL3Coef = as.data.frame(modelSL3Coef)
...
modelIO3Coef = as.data.frame(modelIO3Coef)
...
modelAP3Coef = as.data.frame(modelAP3Coef)
```
...
# Grab descriptives
svyMean3= svymean(ECLSK4, scdrep4)
...
modelSC4Coef = as.data.frame(modelSC4Coef)
...
modelSI4Coef = as.data.frame(modelSI4Coef)
...
modelSL4Coef = as.data.frame(modelSL4Coef)
...
modelIO4Coef = as.data.frame(modelIO4Coef)
...
modelAP4Coef = as.data.frame(modelAP4Coef)
```
