...
SCModelsCombine = as.data.frame(SCModelsCombine)
SCModelsCombine = t(SCModelsCombine)
SCModelsCombine
...
SIModelsCombine = as.data.frame(SIModelsCombine)
SIModelsCombine = t(SIModelsCombine)
SIModelsCombine
...
SLModelsCombine = as.data.frame(SLModelsCombine)
SLModelsCombine = t(SLModelsCombine)
SLModelsCombine
```
...
IOModelsCombine = as.data.frame(IOModelsCombine)
IOModelsCombine = t(IOModelsCombine)
IOModelsCombine
```
